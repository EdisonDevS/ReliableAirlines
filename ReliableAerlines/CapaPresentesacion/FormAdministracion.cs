...
namespace CapaPresentesacion
{
    public partial class FormAdministracion : Form
    {
        ...
        {
            abrirFormularioHijo(new FormMenuNomina());
        ...
        {
            abrirFormularioHijo(new FormMenuBuzon());
            this.pnlActivoNomina.Visible = false;
            this.pnlActivoClientes.Visible = false;
        ...
        {
            abrirFormularioHijo(new FormMenuRutas());
            this.pnlActivoNomina.Visible = false;
            this.pnlActivoClientes.Visible = false;
            this.pnlActivoBuzon.Visible = false;
        ...
        {
            abrirFormularioHijo(new FormMenuAeronaves());
            this.pnlActivoNomina.Visible = false;
            this.pnlActivoClientes.Visible = false;
            this.pnlActivoBuzon.Visible = false;
            this.pnlActivoRuta.Visible = false;
