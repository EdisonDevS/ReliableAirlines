...
{
    public partial class FormConsultaNomina : Form
    {
        public FormConsultaNomina()
        {
            InitializeComponent();
        }
        ...
        {
            abrirFormularioHijo(new FormConsultaNomGeneral());
        ...
        {
            abrirFormularioHijo(new FormAjusteNomina());
