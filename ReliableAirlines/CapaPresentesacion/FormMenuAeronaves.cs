...
{
    public partial class FormMenuAeronaves : Form
    {
        public FormMenuAeronaves()
        {
            InitializeComponent();
        }
        ...
        private void btnRegistrarAeronave_Click(object sender, EventArgs e)
        {
            ...
            abrirFormularioHijo(new FormRegistroAeronave());
        }
        ...
        private void btnAdministrarAeronave_Click(object sender, EventArgs e)
        {
            ...
            abrirFormularioHijo(new FormAdministrarAeronave());
        }
    }
}
