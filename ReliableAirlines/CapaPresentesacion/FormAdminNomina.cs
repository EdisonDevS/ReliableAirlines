...
{
    public partial class FormAdminNomina : Form
    {
        public FormAdminNomina()
        {
            InitializeComponent();
        }
        ...
        {
            abrirFormularioHijo(new FormAdminNominaActualizacion());
        ...
        {
            abrirFormularioHijo(new FormAdminNominaRegistro());
        ...
        {
            abrirFormularioHijo(new FormAdminNominaConsulta());
            btnActualizarEmpleado.BackColor = Color.FromArgb(46, 61, 79);
            btnRegistrarEmpleado.BackColor = Color.FromArgb(46, 61, 79);
