...
CREATE TABLE RUTA
(
	llaveRuta BIGINT IDENTITY(1,1) PRIMARY KEY NOT NULL,
	idRuta VARCHAR(15) NOT NULL,
	origen INT NOT NULL,
...
(
	...
	CONSTRAINT RELACION_A_RUTA FOREIGN KEY (llaveRuta) REFERENCES RUTA(llaveRuta)
)
